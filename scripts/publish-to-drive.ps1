<#
.SYNOPSIS
    Copies a tagged Shopvac release from GitHub to the shared drive.
...
.PARAMETER Tag
    The Git tag to publish, e.g. "v0.2.0".

.PARAMETER DrivePath
    Override the shared drive path (default: G:\Shared drives\R3P RESOURCES\APPS\Shopvac).

.PARAMETER Repo
    GitHub repository in owner/name format (default: chamber-19/shopvac).

.EXAMPLE
    .\scripts\publish-to-drive.ps1 -Tag v0.2.0

.EXAMPLE
    .\scripts\publish-to-drive.ps1 -Tag v0.2.0 -DrivePath "D:\TestDrive\Shopvac"
#>
...
param(
    ...
    [string]$DrivePath = "G:\Shared drives\R3P RESOURCES\APPS\Shopvac",

    [string]$Repo = "chamber-19/shopvac"
)
...
$TempDir = Join-Path $env:TEMP "shopvac-publish-$Tag"
